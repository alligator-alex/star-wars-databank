...
use App\Modules\Databank\Admin\Components\Manufacturer\Layouts\Edit\MainRows;
use App\Modules\Databank\Admin\Components\Manufacturer\Layouts\Edit\SystemLegend;
use App\Modules\Databank\Admin\Enums\ManufacturerRouteName;
use App\Modules\Databank\Admin\Requests\Manufacturer\Create;
use App\Modules\Databank\Admin\Requests\Manufacturer\Update;
...
/**
 * @extends BaseEditScreen<Manufacturer>
 */
class EditScreen extends BaseEditScreen
{
    ...
    {
        return ManufacturerRouteName::LIST;
    }

    protected function createRoute(): BackedEnum
    {
        return ManufacturerRouteName::CREATE;
    }

    protected function updateRoute(): BackedEnum
    {
        return ManufacturerRouteName::UPDATE;
    }

    protected function deleteRoute(): BackedEnum
    {
        return ManufacturerRouteName::DELETE;
    }
