    ...
    protected function columns(): iterable
    {
        return [
            TD::make('id', __('ID'))
                ->cantHide()
                ->sort()
                ->render(static fn (Media $model): View => view('admin.media.index.poster-cell', [
                    'model' => $model,
                ]))
                ->width('100px'),
            ...
            TD::make('name', __('Name'))
                ->cantHide()
                ->sort()
                ->render(static fn (Media $model): View => view('admin.media.index.name-cell', [
                    'model' => $model,
                ]))
                ->width('300px'),
            ...
            TD::make()
                ...
                ->render(static fn (Media $model): DropDown => DropDown::make()
                    ...
                    ->list([
                        Link::make(__('Edit'))
                            ->route(MediaRouteName::EDIT->value, $model->id, false)
                            ->icon('bs.pencil'),
