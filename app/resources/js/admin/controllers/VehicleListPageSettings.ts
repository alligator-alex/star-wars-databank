...
export default class VehicleListPageSettings extends window.Controller {
    ...
    private itemClassName: string = "vehicle-list__item";
    private imageClassName: string = "vehicle-list__image";
    ...
    private initIframeElements(): void {
        ...
        const iframe: HTMLIFrameElement = document.querySelector(".js-list-page-preview");
