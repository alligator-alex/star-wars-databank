...
return [
    ...
    */
    ...
    'profile' => \App\Modules\Core\Admin\Enums\UserRouteName::PROFILE->value,
    ...
    'resource' => [
        'stylesheets' => [
            \App\Modules\Core\Common\Helpers\AssetHelper::assetUrl('/vendor/orchid/css/orchid-override.css'),
        ],
        'scripts'     => [],
    ],
